                        ...
                        <form class="form-material form-horizontal" method="POST" action="<?= $action; ?>"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="<?= $tipe ?>" id="nisn" name="nisn" value="<?= $nisn; ?>"
                                            class="form-control" placeholder="Ketikkan nisn">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="nama_lengkap" name="nama_lengkap"
                                            value="<?= $nama_lengkap; ?>" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" name="tanggal_lahir" value="<?= $tanggal_lahir; ?>"
                                            class="form-control" placeholder="Ketuk tanggal lahir">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea class="form-control" name="alamat" id="alamat" rows="5"
                                            placeholder="Ketikkan alamat"><?= $alamat ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="asal_sekolah" name="asal_sekolah"
                                            value="<?= $asal_sekolah; ?>" class="form-control"
                                            placeholder="Ketikkan asal sekolah">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <button type="submit"
                                        class="btn btn-primary waves-effect waves-light m-r-10">Simpan</button>
                                    <a type="button" href="<?= site_url('controllerSiswa'); ?>"
